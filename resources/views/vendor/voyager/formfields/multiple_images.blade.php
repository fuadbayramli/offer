...
{{--    @endif--}}
{{--@endif--}}
@if(isset($options->model) && $options->model == 'App\OfferFile')
    <div class="clearfix"></div>
    <input type="file" name="images[]" multiple="multiple" accept="image/*">
@elseif(isset($options->model) && $options->model == 'App\OfferVideo')
    <div class="clearfix"></div>
    <input type="file" name="videos[]" multiple="multiple" accept="video/*">
@else
    <div class="clearfix"></div>
