...
use App\Http\Services\OfferFileDataFactory;
use App\Http\Services\OfferVideoDataFactory;
use App\OfferFile;
use App\OfferVideo;
use Exception;
...
class OfferController extends VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($request->images) && $request->images) {
            $paths = fileUpload($request->images);
            OfferFile::insert((new OfferFileDataFactory($paths, ['offer_id' => $id]))->getData());
        }

        if (isset($request->videos) && $request->videos) {
            $videoPaths = videoUpload($request->videos);
            OfferVideo::insert((new OfferVideoDataFactory($videoPaths, ['offer_id' => $id]))->getData());
        }
